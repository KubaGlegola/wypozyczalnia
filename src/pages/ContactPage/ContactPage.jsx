      ...
      <Container className="contactPage__container">
        <div className="contactPage">
          ...
          <div className="contactPage__dataContainer">
            <div
              className="contactPage__addressContainer"
              data-aos="slide-right"
            ...
            <a
              href="mailto:wynajemkustra@wp.pl"
              className="contactPage__link"
              data-aos="slide-right"
          ...
          <div
            className="contactPage__mapContainer"
