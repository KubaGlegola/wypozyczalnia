...
const PrivacyPolicyPage = () => {
  return (
    <Container className="privacyPolicyPage">
      <h2 className="privacyPolicyPage__header">1. Informacje ogólne</h2>
      <ol className="privacyPolicyPage__outerList">
        <li>
          Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem
          url: <b>wypozyczalnia-kustra.pl</b>
        </li>
        <li>
          Operatorem serwisu oraz Administratorem danych osobowych jest: Wynajem
          sprzętu budowlanego Łukasz Kustra Janów 5D 24-100 Puławy
        </li>

        <li>
          Adres kontaktowy poczty elektronicznej operatora: wynajemkustra@wp.pl
        </li>
        ...
        <li>
          ...
          <ol className="privacyPolicyPage__innerList">
            <li>
      ...
      <h2 className="privacyPolicyPage__header">
      ...
      <h2 className="privacyPolicyPage__header">3. Hosting</h2>
      <ol className="privacyPolicyPage__outerList">
        <li>
      ...
      <ol className="privacyPolicyPage__outerList">
        <li>
          ...
          <ul className="privacyPolicyPage__innerList">
            <li>
            ...
            <li>
              firmy, z którymi Administrator współpracuje w zakresie marketingu
              własnego,
            </li>
            <li>kurierzy,</li>
      ...
      <h2 className="privacyPolicyPage__header">6. Logi Administratora</h2>
      <ol className="privacyPolicyPage__outerList">
        <li>
      ...
      <ol className="privacyPolicyPage__outerList">
        ...
        <li>
          Operator może stosować profilowanie w rozumieniu przepisów o ochronie
          danych osobowych
        </li>
      </ol>
